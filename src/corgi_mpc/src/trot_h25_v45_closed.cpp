...
int main(int argc, char **argv) {
    ...
    if (sim) {
        double tmp[8] = {1.6742169285081276,0.15660187698201541,1.6486878524915944,0.03945320109703947,1.6486878524915944,-0.03945320109703947,1.6742169285081276,-0.15660187698201541};
        for (int i = 0; i < 8; ++i) init_eta[i] = tmp[i];
    } else {
        double tmp[8] = {1.614734905606272,0.16093373925617896,1.5884016420123368,0.040562155452540855,1.5884016420123368,-0.040562155452540855,1.614734905606272,-0.16093373925617896};
        for (int i = 0; i < 8; ++i) init_eta[i] = tmp[i];
    }
